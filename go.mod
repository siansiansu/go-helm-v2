...
require (
	...
	k8s.io/helm v0.0.0-20190412093911-8494d133bf18
)
...
require (
	...
	k8s.io/api v0.0.0-20190416052506-9eb4726e83e4 // indirect
	k8s.io/apiextensions-apiserver v0.0.0-20190416053532-f866ca7bfd7e // indirect
	k8s.io/apimachinery v0.0.0-20190416092415-3370b4aef5d6 // indirect
	k8s.io/apiserver v0.0.0-20190416213055-e5a4076f9f3b // indirect
	k8s.io/cli-runtime v0.0.0-20190416053634-32d9cfdc4432 // indirect
	k8s.io/cloud-provider v0.0.0-20190416053958-f05b866e4a87 // indirect
